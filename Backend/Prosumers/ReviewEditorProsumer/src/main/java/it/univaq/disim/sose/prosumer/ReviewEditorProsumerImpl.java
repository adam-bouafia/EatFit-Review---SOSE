...
public class ReviewEditorProsumerImpl implements ReviewEditorProsumer {
	...
	public String insertReview(Review review, RatingData ratingData) {
	    ...
	    try {
	    	if(!ClientAsync.insertRatings(ratingData, review).equals("Review and Rating async inserted successfully")) return "you cannot add more than one review and ratings for food";
